 ...
 */
final class Version20220206140711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE piece_list ADD COLUMN rebrickable_list_id INTEGER UNSIGNED NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_976AC5093DAE168B ON piece_count (list_id)');
        $this->addSql('CREATE INDEX IDX_976AC509C40FCFA8 ON piece_count (piece_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece_list AS SELECT id, name FROM piece_list');
        ...
        $this->addSql('INSERT INTO piece_list (id, name) SELECT id, name FROM __temp__piece_list');
