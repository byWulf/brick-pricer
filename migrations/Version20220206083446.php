 ...
 */
final class Version20220206083446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__external_color AS SELECT id, color_id, name FROM external_color');
        $this->addSql('DROP TABLE external_color');
        $this->addSql('CREATE TABLE external_color (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, system VARCHAR(255) NOT NULL, external_id INTEGER DEFAULT NULL, CONSTRAINT FK_541B3B6A7ADA1FB5 FOREIGN KEY (color_id) REFERENCES color (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO external_color (id, color_id, name) SELECT id, color_id, name FROM __temp__external_color');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece AS SELECT id, color_id, name, image_url FROM piece');
        ...
        $this->addSql('INSERT INTO piece (id, color_id, name, image_url) SELECT id, color_id, name, image_url FROM __temp__piece');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__external_color AS SELECT id, color_id, name FROM external_color');
        $this->addSql('DROP TABLE external_color');
        $this->addSql('CREATE TABLE external_color (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO external_color (id, color_id, name) SELECT id, color_id, name FROM __temp__external_color');
        $this->addSql('DROP TABLE __temp__external_color');
        $this->addSql('CREATE INDEX IDX_541B3B6A7ADA1FB5 ON external_color (color_id)');
        $this->addSql('DROP INDEX IDX_44CA0B237ADA1FB5');
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece AS SELECT id, color_id, name, image_url FROM piece');
        $this->addSql('DROP TABLE piece');
        $this->addSql('CREATE TABLE piece (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO piece (id, color_id, name, image_url) SELECT id, color_id, name, image_url FROM __temp__piece');
        $this->addSql('DROP TABLE __temp__piece');
        $this->addSql('CREATE INDEX IDX_44CA0B237ADA1FB5 ON piece (color_id)');
        $this->addSql('DROP INDEX IDX_976AC5093DAE168B');
