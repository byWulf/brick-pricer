 ...
 */
final class Version20220208161639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece AS SELECT id, color_id, name, image_url, part_number, cached_parts_needed, cached_best_single_price, cached_best_price_sum_needed FROM piece');
        $this->addSql('DROP TABLE piece');
        $this->addSql('CREATE TABLE piece (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL, part_number VARCHAR(255) NOT NULL, cached_parts_needed INTEGER UNSIGNED NOT NULL, cached_best_single_price INTEGER UNSIGNED DEFAULT NULL, cached_best_price_sum_needed INTEGER UNSIGNED DEFAULT NULL, CONSTRAINT FK_44CA0B237ADA1FB5 FOREIGN KEY (color_id) REFERENCES color (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO piece (id, color_id, name, image_url, part_number, cached_parts_needed, cached_best_single_price, cached_best_price_sum_needed) SELECT id, color_id, name, image_url, part_number, cached_parts_needed, cached_best_single_price, cached_best_price_sum_needed FROM __temp__piece');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_541B3B6A7ADA1FB5 ON external_color (color_id)');
        $this->addSql('DROP INDEX IDX_44CA0B237ADA1FB5');
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece AS SELECT id, color_id, part_number, name, image_url, cached_parts_needed, cached_best_single_price, cached_best_price_sum_needed FROM piece');
        $this->addSql('DROP TABLE piece');
        $this->addSql('CREATE TABLE piece (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color_id INTEGER DEFAULT NULL, part_number VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL, cached_parts_needed INTEGER UNSIGNED NOT NULL, cached_best_single_price INTEGER UNSIGNED DEFAULT NULL, cached_best_price_sum_needed INTEGER UNSIGNED DEFAULT NULL)');
        $this->addSql('INSERT INTO piece (id, color_id, part_number, name, image_url, cached_parts_needed, cached_best_single_price, cached_best_price_sum_needed) SELECT id, color_id, part_number, name, image_url, cached_parts_needed, cached_best_single_price, cached_best_price_sum_needed FROM __temp__piece');
        $this->addSql('DROP TABLE __temp__piece');
        $this->addSql('CREATE INDEX IDX_44CA0B237ADA1FB5 ON piece (color_id)');
        $this->addSql('DROP INDEX IDX_976AC5093DAE168B');
        $this->addSql('DROP INDEX IDX_976AC509C40FCFA8');
