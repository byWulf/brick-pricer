 ...
 */
final class Version20220208110648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece_price AS SELECT id, piece_id, source, price FROM piece_price');
        ...
        $this->addSql('INSERT INTO piece_price (id, piece_id, source, price) SELECT id, piece_id, source, price FROM __temp__piece_price');
