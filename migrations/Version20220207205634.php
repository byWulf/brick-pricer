 ...
 */
final class Version20220207205634 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE piece (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL, part_number VARCHAR(255) NOT NULL, cached_parts_needed INTEGER UNSIGNED NOT NULL, CONSTRAINT FK_44CA0B237ADA1FB5 FOREIGN KEY (color_id) REFERENCES color (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO piece (id, color_id, name, image_url, part_number, cached_parts_needed) SELECT id, color_id, name, image_url, part_number, 0 FROM __temp__piece');
