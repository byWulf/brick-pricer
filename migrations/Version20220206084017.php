 ...
 */
final class Version20220206084017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__external_color AS SELECT id, color_id, system FROM external_color');
        ...
        $this->addSql('INSERT INTO external_color (id, color_id, system) SELECT id, color_id, system FROM __temp__external_color');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__external_color AS SELECT id, color_id, system FROM external_color');
        $this->addSql('DROP TABLE external_color');
        $this->addSql('CREATE TABLE external_color (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color_id INTEGER DEFAULT NULL, system VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, external_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO external_color (id, color_id, system) SELECT id, color_id, system FROM __temp__external_color');
        $this->addSql('DROP TABLE __temp__external_color');
        $this->addSql('CREATE INDEX IDX_541B3B6A7ADA1FB5 ON external_color (color_id)');
        $this->addSql('DROP INDEX IDX_44CA0B237ADA1FB5');
