 ...
 */
final class Version20220206141242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece AS SELECT id, color_id, name, image_url, part_number FROM piece');
        $this->addSql('DROP TABLE piece');
        $this->addSql('CREATE TABLE piece (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL, part_number VARCHAR(255) NOT NULL, CONSTRAINT FK_44CA0B237ADA1FB5 FOREIGN KEY (color_id) REFERENCES color (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO piece (id, color_id, name, image_url, part_number) SELECT id, color_id, name, image_url, part_number FROM __temp__piece');
        ...
        $this->addSql('ALTER TABLE piece_list ADD COLUMN need_import BOOLEAN NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_541B3B6A7ADA1FB5 ON external_color (color_id)');
        $this->addSql('DROP INDEX IDX_44CA0B237ADA1FB5');
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece AS SELECT id, color_id, part_number, name, image_url FROM piece');
        $this->addSql('DROP TABLE piece');
        $this->addSql('CREATE TABLE piece (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, color_id INTEGER DEFAULT NULL, part_number VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO piece (id, color_id, part_number, name, image_url) SELECT id, color_id, part_number, name, image_url FROM __temp__piece');
        $this->addSql('DROP TABLE __temp__piece');
        $this->addSql('CREATE INDEX IDX_44CA0B237ADA1FB5 ON piece (color_id)');
        $this->addSql('DROP INDEX IDX_976AC5093DAE168B');
        $this->addSql('DROP INDEX IDX_976AC509C40FCFA8');
        ...
        $this->addSql('CREATE INDEX IDX_976AC5093DAE168B ON piece_count (list_id)');
        $this->addSql('CREATE INDEX IDX_976AC509C40FCFA8 ON piece_count (piece_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece_list AS SELECT id, name, rebrickable_list_id FROM piece_list');
        $this->addSql('DROP TABLE piece_list');
        $this->addSql('CREATE TABLE piece_list (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, rebrickable_list_id INTEGER UNSIGNED NOT NULL)');
        $this->addSql('INSERT INTO piece_list (id, name, rebrickable_list_id) SELECT id, name, rebrickable_list_id FROM __temp__piece_list');
        $this->addSql('DROP TABLE __temp__piece_list');
        $this->addSql('DROP INDEX IDX_4CE21405C40FCFA8');
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece_number AS SELECT id, piece_id, system, ids FROM piece_number');
        $this->addSql('DROP TABLE piece_number');
        $this->addSql('CREATE TABLE piece_number (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, piece_id INTEGER UNSIGNED DEFAULT NULL, system VARCHAR(255) NOT NULL, ids CLOB NOT NULL --(DC2Type:json)
