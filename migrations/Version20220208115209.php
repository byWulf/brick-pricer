 ...
 */
final class Version20220208115209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO piece (id, color_id, name, image_url, part_number, cached_parts_needed, cached_best_single_price) SELECT id, color_id, name, image_url, part_number, cached_parts_needed, cached_best_price FROM __temp__piece');
