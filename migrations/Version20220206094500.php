 ...
 */
final class Version20220206094500 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece_number AS SELECT id, piece_id, system FROM piece_number');
        ...
        $this->addSql('INSERT INTO piece_number (id, piece_id, system) SELECT id, piece_id, system FROM __temp__piece_number');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__piece_number AS SELECT id, piece_id, system FROM piece_number');
        $this->addSql('DROP TABLE piece_number');
        $this->addSql('CREATE TABLE piece_number (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, piece_id INTEGER UNSIGNED DEFAULT NULL, system VARCHAR(255) NOT NULL, number VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO piece_number (id, piece_id, system) SELECT id, piece_id, system FROM __temp__piece_number');
        $this->addSql('DROP TABLE __temp__piece_number');
        $this->addSql('CREATE INDEX IDX_4CE21405C40FCFA8 ON piece_number (piece_id)');
        $this->addSql('DROP INDEX IDX_56798A4885F87422');
